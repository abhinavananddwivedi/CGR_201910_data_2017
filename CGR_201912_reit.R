...
temp_reg <- purrr::map2(nest_df_reit_LHS_regular$LHS_country_regular[-1],
                        nest_df_reit_LHS_regular$PC_out_sample_90[-1],
                        func_lm_adj_rsqr)
...
temp_div_list <- nest_df_reit_LHS_regular$Div_index
